...
const ProjectCard = ({ title, description, imgPath, ghLink, demoLink, tags }) => {
    return (
        <motion.div
        ...
        >
            <div className="relative aspect-video overflow-hidden">
                ...
                <div className="absolute inset-0 bg-background/40 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-700 z-20 flex items-center justify-center gap-6">
                    {ghLink && (
                        <motion.a
                            href={ghLink}
                            target="_blank"
